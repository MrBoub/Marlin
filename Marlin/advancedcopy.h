...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  //#define Z_STEPPER_ALIGN_XY { {  37, 105 }, { 180,  105 } }
 ...
 */
#if PROBE_SELECTED && !IS_KINEMATIC //Net tussen magneten in dus perfec
